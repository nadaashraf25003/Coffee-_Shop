...
<body>
    ...
    <div class="check dark">
        <div class="mycheck">
            <h1 style="font-family: sans-serif; display: inline-block;"><span>CHECKOUT</span></h1>
            <div style="font-family: Merriweather, serif; font-style: italic; font-weight: 400; font-size: 18px;float: right; padding: 30px 0px;">
                ...
                <span style="color: #C7A17A;"> / Checkout</span>
            </div>
        </div>
        <div class="container">
            <div class="login">
                <h1 style="color: #835e39;">checkout</h1>
                <label for="username"><p>User name or email address:</p></label>
                <input type="email" class="email" name="username" style="height: 52px;">
                <label for="password"><p>Password:</p></label>
                <input type="password" class="password" name="password" style="height: 52px;">
                <label for="promocode"><p>Promo Code:</p></label>
                <input type="text" class="promocode" name="promocode" style="height: 52px; margin-bottom: 20px;">
                <button class="buttonl" role="button">apply promo code</button>
                <label for="adres"><p>Address:</p></label>
                <input type="text" class="adres" name="adres" style="height: 52px;">
                <p>
                    <button class="buttonl" role="button">Submit</button>
